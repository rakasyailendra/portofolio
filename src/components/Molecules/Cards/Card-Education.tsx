    ...
    <Card className="flex flex-row-reverse max-w-[536px] justify-end font-ghaly rounded-[6px] border-gray-300 dark:border-gray-500 dark:bg-[#0e1111] hover:scale-[1.02] hover:duration-300 animate-shadow hover:shadow-lg">
      <Reveal delay={0.05} duration={0.8}>
        <CardHeader className="py-5 pr-3">
          ...
          {/* [PERBAIKAN] Awalan "dark:" dihapus dari beberapa kelas di bawah ini.
            Ini membuat efek gradasi pada teks (text-transparent, bg-clip-text, color-base-ghaly)
            berlaku untuk SEMUA mode, bukan hanya Dark Mode.
          */}
          <CardDescription className="w-auto font-semibold text-transparent bg-clip-text color-base-ghaly">
            {major}
          </CardDescription>
