...
export default function CardProject({
  ...
  return (
    // [PERUBAHAN] Menambahkan kelas 'group' di sini
    <Card
      className="group relative flex flex-col-reverse w-fit sm:w-[350px] lg:max-w-[350px] justify-between font-ghaly rounded-[6px] cursor-pointer active:scale-[0.90] border-gray-300 dark:border-gray-500 dark:bg-[#0e1111] hover:scale-[1.02] hover:duration-300 animate-shadow hover:shadow-lg"
      onMouseOver={() => setLineHover("line-effect")}
      onMouseLeave={() => setLineHover("")}
      onClick={handleDirectLink}
    >
      <CardHeader className="p-4 h-[175px]">
      ...
      <CardContent className="p-0">
        ...
        <div className="relative h-[180px] w-full sm:w-[350px] rounded-t-sm overflow-hidden flex-shrink-0">
          <Image
