...
export function TabEduCertificates({ educations, certificates }: Types) {
  ...
  return (
    <section className="flex flex-col items-center justify-center font-ghaly ">
      ...
      <Reveal delay={0.2} duration={0.5} width="100%">
        {/* [PERBAIKAN FINAL] Menggunakan teknik CSS Masking untuk hasil sempurna */}
        <div
          className="w-full max-w-3xl h-[18px] mx-auto bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600 
                     [-webkit-mask-image:radial-gradient(ellipse_at_bottom,white_10%,transparent_70%)]
                     [mask-image:radial-gradient(ellipse_at_bottom,white_10%,transparent_70%)]"
        />
      </Reveal>
